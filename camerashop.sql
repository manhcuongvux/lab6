...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 01, 2015 at 03:49 AM
...
(17, 'Thái Đình Vũ', 'vutdps02249@fpt.edu.vn', 982651267, 'Welcome to CameraShop Online\r\nAdmin: Đình Vũ'),
(18, 'Vũ Mạnh Cường', 'cuongtdps02241@fpt.edu.vn', 901234567, 'Hello! CameraShop');
...
(15, 'vutdps02249', '123456', 'Thái Đình Vũ', 'vutdps02249@fpt.edu.vn', 'admin', '', '391A Nam Kỳ Khởi Nghĩa, Quận 3,TP.HCM', 982651267),
(17, 'thaidinhvu01', '123abc', 'User Guest 01', 'guest01@yahoo.com', 'user', '', '456 user, Quận user,TP.user', 901654321),
(18, 'thaidinhvu02', '123cba', 'User Guest02', 'guest02@yahoo.com', 'user', '', '789 user, Quan user, TP.user', 909873210),
...
ALTER TABLE `products`
 ADD PRIMARY KEY (`ProductID`), ADD UNIQUE KEY `PKMA_Image` (`ProductImage`), ADD KEY `PKMA_Image_2` (`ProductImage`), ADD KEY `PKMA_Image_3` (`ProductImage`);
...
--
ALTER TABLE `orderdetails`
MODIFY `OrderID` int(12) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
